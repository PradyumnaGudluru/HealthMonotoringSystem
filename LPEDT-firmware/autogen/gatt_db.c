...
{
  0x57, 0x4f, 0x08, 0xa0, 0x10, 0x79, 0x11, 0xb0, 0xdb, 0x47, 0x5d, 0x7b, 0xd4, 0x43, 0x0e, 0xb0, 
  0xba, 0xee, 0x61, 0x30, 0x32, 0x2e, 0xfc, 0xa3, 0xd1, 0x46, 0xa1, 0x5b, 0x39, 0x59, 0x7d, 0x87, 
  0x10, 0x68, 0x73, 0x9e, 0x30, 0x40, 0x03, 0xba, 0x50, 0x4b, 0x65, 0x8d, 0x87, 0xf9, 0x5f, 0xbd, 
  0x2a, 0x64, 0x67, 0x9b, 0xcd, 0xf8, 0x7e, 0xb4, 0x07, 0x49, 0xae, 0x04, 0x9b, 0x35, 0xb1, 0xd4, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_34) = {
  .len = 16,
  .data = { 0x72, 0x67, 0x35, 0x37, 0x8a, 0x7e, 0xdb, 0x80, 0x02, 0x48, 0xb5, 0x3b, 0x34, 0x64, 0xd3, 0x8a, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_30) = {
  .len = 16,
  .data = { 0x1a, 0xed, 0x29, 0xb8, 0x37, 0x3f, 0x7e, 0xa6, 0x7c, 0x41, 0x4a, 0xa8, 0x32, 0x96, 0x90, 0x76, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_26) = {
  .len = 16,
  .data = { 0xcc, 0xb1, 0xaa, 0x04, 0x32, 0x06, 0xa0, 0xb1, 0xbb, 0x40, 0x75, 0x44, 0xd9, 0xd7, 0xb1, 0x1d, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_22) = {
  .len = 16,
  .data = { 0x91, 0x3f, 0x27, 0x75, 0x1e, 0x51, 0xec, 0x9d, 0xe7, 0x45, 0xf4, 0x97, 0x11, 0xd1, 0x91, 0xa8, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 7,
  .data = { 0x52, 0x61, 0x6d, 0x00, 0x00, 0x00, 0x00, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x16, .uuid = 0x0008, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x01, .clientconfig_index = 0x01 } },
  { .handle = 0x17, .uuid = 0x0000, .permissions = 0x8801, .caps = 0xffff, .state = 0x00, .datatype = 0x00, .constdata = &gattdb_attribute_field_22 },
  { .handle = 0x18, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x02, .char_uuid = 0x8000 } },
  { .handle = 0x19, .uuid = 0x8000, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_24 },
  { .handle = 0x1a, .uuid = 0x0008, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x01, .clientconfig_index = 0x02 } },
  ...
  { .handle = 0x20, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x02, .char_uuid = 0x8002 } },
  { .handle = 0x21, .uuid = 0x8002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_32 },
  { .handle = 0x22, .uuid = 0x0008, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x01, .clientconfig_index = 0x04 } },
  ...
  { .handle = 0x25, .uuid = 0x8003, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_36 },
  { .handle = 0x26, .uuid = 0x0008, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x01, .clientconfig_index = 0x05 } },
  { .handle = 0x27, .uuid = 0x0000, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x00, .constdata = &gattdb_attribute_field_38 },
  { .handle = 0x28, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x08, .char_uuid = 0x8004 } },
  { .handle = 0x29, .uuid = 0x8004, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
};
