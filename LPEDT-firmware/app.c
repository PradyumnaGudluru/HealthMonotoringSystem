...
SL_WEAK void app_init(void)
{
  ...
  gpioInit();
//  oscillatorinit(); // Oscillator initialization
//  letimerinit();  // LETIMER initialization

  initLETIMER0(LETIMER_PERIOD_MS, SL_POWER_MANAGER_EM3);

  scheduler_init();
  i2c0_Init();
  i2c1_Init();
  TMP117_set_shutdown_mode();
  MAX_30101_Init(); //Max Init function
  LOG_INFO("System starts\r\n");
...
void sl_bt_on_event(sl_bt_msg_t *evt)
{
  ...
  system_state_machine(evt);    // put this code in scheduler.c/.h
